...
<body style="background: #FAC18B">
  ...
  <div style="margin-left:250px; height: auto;" class="container">
    ...
    <br>
    <div style="color:#2A8BD3" class="title"><b>TRADER REGISTRATION</b></div>
    ...
    <div class="content">
      ...
      <form method="POST" action='signupchecktrader.php'>
        <div class="user-details">
          ...
          <div class="input-box">
            <span class="details">Trader Type</span>
            <input type="text" name="ttype" placeholder="Trader Type">
          </div>
        ...
        <div class="button">
          <input type="submit" name="tregister" Value="REGISTER">
        </div>

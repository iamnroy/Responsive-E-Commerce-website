                ...
                <div class='row outer-bottom-sm'>
                    ...
                    <div class='col-md-9'>
                        ...
                        <div id="category" class="category-carousel hidden-xs">
                            <div class="item">
                                <div class="image">
                                    <img src="image/grocerycat.jpg" alt="" width="850" height="255" class="">
                                </div>
                                <div class="container-fluid">
                                    <div class="caption vertical-top text-left">
                                        ...
                                        <?php
                                        $stid = oci_parse($conn, " SELECT CATEGORY_NAME FROM CATEGORY WHERE CATEGORY_ID='$cid'");
                                        $result = oci_execute($stid);
                                ...
                                <div class="tab-pane active " id="grid-container">
                                    <div class="category-product  inner-top-vs">
                                        <div class="row">
                                            ...
                                            $stid = oci_parse($conn, " SELECT * FROM PRODUCT1 WHERE STATUS='ENABLE' AND CATEGORY_ID='$cid'");
                                                        ...
                                                        <div class="products">
                                                            <div class="product">
                                                                <div class="product-image">
                                                                    <div class="image">
                                                                        <a href="product-detail.php?pid=<?php echo htmlentities($row['0']); ?>"><img style="border-radius: 7px;" src="<?php echo htmlentities($row['8']); ?>" alt="Product Image" width="200" height="240" alt=""></a>
                                                                    </div>
                                                                </div>

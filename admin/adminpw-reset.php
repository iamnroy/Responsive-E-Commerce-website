...
if (isset($_POST['changepw'])) {
    ...
    if (!($password1 == $password2)) {
        ...
        $query = oci_parse($conn, " SELECT * FROM ADMIN WHERE EMAIL='$email' ");
        ...
        if ($res == 1) {
            ...
            $stid = oci_parse($conn, " UPDATE ADMIN SET PASSWORD='$password1' WHERE EMAIL='$email' ");
            ...
            <div class="card-body">
                ...
                <form action="" method="POST" style="align-items: center; background-color: rgb(180, 185, 185);">
                    ...
                    <div class="text-center">
                        <input type="submit" class="btn-upper btn btn-primary checkout-page-button" name="changepw" value="RESET PASSWORD">
                    </div>
                </form>

...
if (isset($_POST['alogin'])) {
  ...
  if (empty($email)) {
    ...
    $pass1 = md5($pass1);
    //$pass1 = $pass1;
    $stid = oci_parse($conn, " SELECT * FROM ADMIN WHERE email='$email' AND password='$pass1' ");
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../trader/css/tstyle.css">
  <style>
    body {
...
<body style="background: #E2F7ED">
  ...
  <div class="header" style="background: #E2F7ED">
  ...
  <div style="background: #E2F7ED" class="content">
    <form method="POST" action="" style="background: pink;">
      <h2 style="color: darkblue"><u>ADMIN LOGIN</u></h2>
      ...
      <label><a href="adminpw-reset.php" style="text-decoration: none"> Forgot Password?</a></label>
      <button type="submit" name="alogin" style="cursor: pointer;">LOGIN</button>
    </form>

...
$sql = oci_parse($conn, " DELETE FROM TRADER WHERE TRADER_ID='$tdel'");
$res = oci_execute($sql);
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="add-product main-parts mt-2">
                            ...
                            <div class="text-center1">
                                <a href="addtrader.php"> <input type="submit" value="ADD TRADER &raquo;" class="btn btn-add-products"></a>
                            </div>
                                    ...
                                    if ($result != false)
                                        ...
                                        <tr>
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <td> <a href="traderlist.php?tdel=<?php echo $data['TRADER_ID']; ?>" onClick="edit(this);" title="Edit"> DELETE</a>
                                                </td>
                                            </form>
                                        </tr>
                                </tbody>
